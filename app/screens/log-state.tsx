...
import { IconBubble, PressScale, PrimaryAction, SectionHeader, SurfaceCard } from '../../src/components/ui';
    ...
    <ModalScreen title={copy.title} keyboard>
      <View style={styles.screenBody}>
        ...
        <View style={[styles.stickyFooter, { backgroundColor: isDark ? 'rgba(23,19,29,0.98)' : 'rgba(255,253,254,0.98)', borderTopColor: colors.outlineVariant }]}>
          <PrimaryAction label={saving ? `${copy.save}…` : copy.save} icon="check" onPress={save} disabled={saving} />
        </View>
      </View>
    </ModalScreen>
  );
